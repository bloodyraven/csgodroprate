...
public class Constantes {
	...
	public static final String EMPTY_WEAPON_NAME = "Veuillez donner un nom à l'arme.";
	public static final String EMPTY_WEAPON_LIST = "Veuillez enregister au moins une arme.";
	public static final String NOT_100_PERCENT = "Le total des drop rate doit être égal à 100%.";
